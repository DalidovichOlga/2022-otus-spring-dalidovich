...
public class LibraryShell {
    ...
    @ShellMethod(value = "delete comment", key = {"commod", "dmodifybookcomment"})
    public String modifyCommentBook(Long bookId, int numberComment, String text, @ShellOption(defaultValue = "")  String nick) {
        String textResult = "";
        try {
            commentService.modifyComment(bookId, numberComment, text , nick);
            textResult = messageSource.getMessage("commentsuccessmod",
                    new String[]{String.valueOf(numberComment)}, locale);
